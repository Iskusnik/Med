        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (ModelMedDBContainer db = new ModelMedDBContainer())
            {
                ...
                switch (comboBox1.SelectedIndex)
                {
                    case 0:
                        {
                            var thisPersonVisits = (from visit in thisPatient.VisitInfo select new { visit.DateStart, visit.WorkTime.Doctor.FullName }).ToList();
                    ...
                    case 1:
                        {
                            var thisPersonVisits = (from visit in thisPatient.VisitInfo where (visit.DateStart > DateTime.Today) select new { visit.DateStart, visit.WorkTime.Doctor.FullName }).ToList();
